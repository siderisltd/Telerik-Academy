...
public class FigureDoubleDot : Figure
{
	private const int score = 2; // tegloto na vsqka figura, hubavo e da e i stati4na


	// constructor
	public FigureDoubleDot (int player) : base(player)
    {
