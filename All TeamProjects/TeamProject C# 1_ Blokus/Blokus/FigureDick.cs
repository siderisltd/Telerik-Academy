        ...
        public override void rotate()
        {
            ...
            switch (currentPossition)
            {
                ...
                case 4:
                    ...
                    figure[5, 3] = figure[5, 4] = figure[4, 4] = figure[3, 4] = figure[5, 5] = owner;
                    break;
                ...
                case 5: // tuk znaem ot kakvo systoqnie idvame i promenqme direktno masiva po indeksi
                    ...
                    figure[3, 3] = figure[4, 3] = figure[5, 3] = figure[4, 4] = figure[4, 5] = owner;
                    break;
                ...
                case 6:
                    ...
                    figure[3, 5] = figure[4, 5] = figure[5, 5] = figure[4, 4] = figure[4, 3] = owner;
                ...
                case 7:
                    {
                        ...
                        figure[3, 3] = figure[3, 4] = figure[4, 4] = figure[3, 5] = figure[5, 4] = owner;
                        break;
                    }
            }
        }
